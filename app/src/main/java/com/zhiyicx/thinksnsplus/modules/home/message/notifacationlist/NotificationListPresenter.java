 ...
 */
@FragmentScoped
public class NotificationListPresenter extends AppBasePresenter<NotificationListContract.View>
        implements NotificationListContract.Presenter {
    ...
    @Inject
    public NotificationListPresenter(NotificationListContract.View rootView) {
        super(rootView);
    }
