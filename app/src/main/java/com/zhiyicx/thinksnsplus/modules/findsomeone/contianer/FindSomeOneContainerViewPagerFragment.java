...
public class FindSomeOneContainerViewPagerFragment extends TSViewPagerFragment {
    ...
    public static FindSomeOneContainerViewPagerFragment newInstance() {
        FindSomeOneContainerViewPagerFragment findSomeOneContainerFragment = new FindSomeOneContainerViewPagerFragment();
