 ...
 */
public abstract class TSViewPagerFragmentV3<P extends ITSListPresenter<T>,T extends BaseListBean> extends TSListFragment<P,T> {
    private static final int DEFAULT_OFFSET_PAGE = 3;
    protected TabSelectView mTsvToolbar;
    protected ViewPager mVpFragment;
    protected TSViewPagerAdapterV2 tsViewPagerAdapter;
