...
public abstract class TSExpandListFragment<P extends ITSListPresenter<T>, T extends BaseListBean> extends TSFragment<P> implements ITSListView<T, P>, com
     ...
     * 列表控件
     */
    protected ExpandableListView mLvList;
    ...
    protected int getBodyLayoutId() {
        return R.layout.fragment_expand_tslist;
    }
    ...
    protected void initView(View rootView) {
        ...
        mLvList = (ExpandableListView) rootView.findViewById(R.id.swipe_target);

        mRefreshlayout.setOnRefreshListener(this);
        mRefreshlayout.setOnLoadmoreListener(this);
        if (setListBackColor() != -1) {
            mLvList.setBackgroundColor(ContextCompat.getColor(getContext(), setListBackColor()));
        }
