    ...
    protected View getContentView() {
        ...
        if (setUseSatusbar() && setUseStatusView()) {
            ...
            if (StatusBarUtils.intgetType(getActivity().getWindow()) == 0 && ContextCompat.getColor(getContext(), setToolBarBackgroud()) == Color
                    .WHITE) {
                mStatusPlaceholderView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.bgColor));
            } else {
...
//                    });
    ...
    protected void initDefaultToolBar(View toolBarContainer) {
        ...
        mToolbarCenter.setCompoundDrawables(UIUtils.getCompoundDrawables(getContext(), setTitleDrawableLeft()), null, null, null);
